...
public class DaoTest {
	...
	public void testQry() {
		...
		JsonResult result = GoSqlGoServlet.doActionBody(req, resp);
		System.out.println(result.getData());
		Assert.assertEquals("500", result.getData());
	}
	...
	public void testJava() {
		...
		JsonResult result = GoSqlGoServlet.doActionBody(req, resp);
		Assert.assertEquals("Transfer Success!|400|600", result.getData());
	}
